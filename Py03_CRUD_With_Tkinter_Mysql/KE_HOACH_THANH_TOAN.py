# Note
# https://www.tutussfunny.com/python-crud-tkinter-step-by-step-mysql-database/#google_vignette
# python -m pip install mysql-connector 
# Source Code
# https://www.tutussfunny.com/python-crud-tkinter-step-by-step-mysql-database/
