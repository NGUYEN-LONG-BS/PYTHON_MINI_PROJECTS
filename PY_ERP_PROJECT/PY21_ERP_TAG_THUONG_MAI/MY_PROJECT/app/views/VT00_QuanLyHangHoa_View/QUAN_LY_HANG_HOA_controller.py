...
class controller_create_new_inventory:
    def start_create_new_inventory(entry_notification,
        ...
        try:
            ...
            ma_kho_luu_tru = ''
            flag = controller_create_new_inventory.insert_inventory_category(session, id_nhan_vien, xoa_sua, ma_hang, ten_hang, dvt, sl_ton_dau_ky, don_gia_ton_dau_ky, ma_kho_luu_tru)
            if flag == False:
                return False
    ...
    def insert_inventory_category(session, id_nhan_vien, xoa_sua, ma_hang, ten_hang, dvt, sl_ton_dau_ky, don_gia_ton_dau_ky, ma_kho_luu_tru):
        try:
            
            print(f"id_nhan_vien: {id_nhan_vien}")
            print(f"xoa_sua: {xoa_sua}")
            print(f"ma_hang: {ma_hang}")
            print(f"ten_hang: {ten_hang}")
            print(f"dvt: {dvt}")
            print(f"sl_ton_dau_ky: {sl_ton_dau_ky}")
            print(f"don_gia_ton_dau_ky: {don_gia_ton_dau_ky}")
            print(f"ma_kho_luu_tru: {ma_kho_luu_tru}")
            
            # Tạo đối tượng mới từ lớp InventoryCategory
            new_inventory = utils_model_all_table.InventoryCategory(
                # ID=None,  # Leave ID to be automatically generated by NEWID()
                # DATE=None,  # Leave DATE to be automatically generated by GETDATE()
                ID_NHAN_VIEN=id_nhan_vien,
                XOA_SUA=xoa_sua,
                MA_HANG=ma_hang,
                TEN_HANG=ten_hang,
                DVT=dvt,
                # TEN_HANG=f"u'Mặt hàng A'",
                # DVT='bộ',
