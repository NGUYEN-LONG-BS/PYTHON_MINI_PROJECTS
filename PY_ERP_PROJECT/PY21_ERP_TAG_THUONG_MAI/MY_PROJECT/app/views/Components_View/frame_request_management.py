...
# Model: cls_frame_request_management_model
class cls_frame_request_management_model:
    def __init__(self):
...
# Controller: cls_frame_request_management_controller
class cls_frame_request_management_controller:
    def __init__(self):
        self.model = cls_frame_request_management_model()  # Create an instance of the model
...
# View: cls_frame_request_management_view
class cls_frame_request_management_view(tk.Frame):
    ...
    def _f_setup_MVC(self):
        self.controller = cls_frame_request_management_controller()  # Create an instance of the controller

    def _f_create_widgets_of_frame_row_1(self):
        # Create label and TreeviewCombobox
        label_contract_ID = ttk.Label(self.frame_row_1, text="Số đề nghị:")
        ...
        entry_contract_short_info = entry.cls_my_date_time_entry_num_01(self.frame_row_1, name="entry_ngay_de_nghi")
