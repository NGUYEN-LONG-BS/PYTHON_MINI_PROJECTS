...
class cls_KE_HOACH_DAT_HANG_View(cls_base_form_number_02_ManyTabs):
    def __init__(self):
        title = "KD02 | QUẢN LÝ KẾ HOẠCH ĐẶT HÀNG"
        name = "QUẢN LÝ KẾ HOẠCH ĐẶT HÀNG"
    ...
    def f_define_all_elements(self):
        ...
        self.tab_01_entry_mst = f_utils_tim_component_with_name(tab_01_frame, "entry_mst_khach_hang")
        self.tab_01_entry_dia_chi = f_utils_tim_component_with_name(tab_01_frame, "entry_dia_chi_khach_hang")
    ...
    def f_view_thay_doi_gia_tri_cua_base_form(self):
        ...
        notebook.tab(0, text="TẠO MỚI KẾ HOẠCH ĐẶT HÀNG")
        notebook.tab(1, text="QUẢN LÝ KẾ HOẠCH ĐẶT HÀNG")
    ...
    def _f_view_create_widgets_in_tab_01_frame_H2(self):
        # Title H2
        cls_my_label_num_03_title_H2(self.tab_01_frame_H2, text="PHIẾU KẾ HOẠCH ĐẶT HÀNG").pack(anchor="center")
    ...
    def _f_view_create_widgets_in_tab_02_frame_H2(self):
        # Title H2
        cls_my_label_num_03_title_H2(self.tab_02_frame_H2, text="NHẬT KÝ KẾ HOẠCH ĐẶT HÀNG").pack(anchor="center")
