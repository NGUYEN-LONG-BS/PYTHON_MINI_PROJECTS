...
arr_04 = os.listdir(r"\\172.16.0.191\2.0 ksnb\TUAN_AN_GROUP\BAN_TAI_CHINH")
...
def ThucHienVongLap():
    ...
    for index in arr_04:
        ...
        if len(index) > 0 and file_extention == ".pdf":
            # print(index)
            old_path = os.path.join(r"\\172.16.0.191\2.0 ksnb\TUAN_AN_GROUP\BAN_TAI_CHINH",index)
            File_name_order = 1
            new_path = os.path.join(r"\\172.16.0.191\2.0 ksnb\TUAN_AN_GROUP\BAN_TAI_CHINH",file_name + str(File_name_order) + file_extention)
