...
# https://www.youtube.com/watch?v=mJc5gAnnlVQ&list=PLs3IFJPw3G9IiHm9PEP1UaMtuvACmxVMj&index=8
...
window = tkinter.Tk()
window.title("Kế hoạch thanh toán")

frame = tkinter.Frame(window)
frame.pack(padx=20, pady=10)

first_name_label = tkinter.Label(frame, text="Mã đối tượng")
first_name_label.grid(row=0, column=0)
last_name_label = tkinter.Label(frame, text="Tên đối tượng")
