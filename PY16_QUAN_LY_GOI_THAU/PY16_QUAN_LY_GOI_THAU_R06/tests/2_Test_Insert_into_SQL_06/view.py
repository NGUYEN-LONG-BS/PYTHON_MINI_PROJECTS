...
class CRUDTreeviewView:
    ...
    def f_add_elements_to_frame_entries_of_treeview(self):
        # Row 0: inventory ID
        label_ma_HH = tk.Label(self.frame_entries_of_treeview, text=f"Mã HH:")
        label_ma_HH.grid(row=0, column=0, padx=10, pady=5, sticky="w")
        
        entry_ma_hh = tk.Entry(self.frame_entries_of_treeview)
        entry_ma_hh.insert(0, "")  # Set the default value
        entry_ma_hh.grid(row=0, column=1, padx=10, pady=5, sticky="w")
        
        # Row 0: inventory Name - Span to the end of the frame
        label_ten_hh = tk.Label(self.frame_entries_of_treeview, text=f"Tên HH:")
        label_ten_hh.grid(row=0, column=2, padx=10, pady=5, sticky="w")
        
        entry_ten_hh = tk.Entry(self.frame_entries_of_treeview)
        entry_ten_hh.insert(0, "")  # Set the default value
        entry_ten_hh.grid(row=0, column=3, columnspan=2, padx=10, pady=5, sticky="ew")
        
        # Row 1: unit
        label_unit = tk.Label(self.frame_entries_of_treeview, text=f"Đvt:")
        label_unit.grid(row=1, column=0, padx=10, pady=5, sticky="w")
        
        entry_unit = tk.Entry(self.frame_entries_of_treeview)
        entry_unit.insert(0, "")  # Set the default value
        entry_unit.grid(row=1, column=1, padx=10, pady=5, sticky="w")
        
        # Row 1: quantity
        label_quantity = tk.Label(self.frame_entries_of_treeview, text=f"Đvt:")
        label_quantity.grid(row=1, column=2, padx=10, pady=5, sticky="w")
        
        entry_quantity = tk.Entry(self.frame_entries_of_treeview)
        entry_quantity.insert(0, "")  # Set the default value
        entry_quantity.grid(row=1, column=3, padx=10, pady=5, sticky="w")
