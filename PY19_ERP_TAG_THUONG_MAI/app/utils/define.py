...
PATH_CARD_ADMIN_QUAN_LY_DATABASE = os.path.join(PATH_ROOT, "assets/img/ADMIN_QUAN_LY_DATABASE.png")
PATH_CARD_ADMIN_CAI_DAT_CHUNG = os.path.join(PATH_ROOT, "assets/img/ADMIN_CAI_DAT_CHUNG.png")
