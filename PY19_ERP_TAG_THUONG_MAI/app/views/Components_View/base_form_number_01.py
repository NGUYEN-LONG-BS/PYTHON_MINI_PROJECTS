...
class cls_base_form_number_01(tk.Tk):
    ...
    def f_add_elements_to_frame_info_of_slip(self):
        ...
        entry_date_on_slip = tk.Entry(self.frame_info_of_slip)
        ...
        entry_number_of_slip = tk.Entry(self.frame_info_of_slip)
        ...
        entry_ma_doi_tuong = tk.Entry(self.frame_info_of_slip)
        ...
        entry_ten_doi_tuong = tk.Entry(self.frame_info_of_slip)
