...
class cls_Dashboard_admin_View(cls_base_form_number_02_ManyTabs):
    def __init__(self):
        title = "AD00 - Dashboard Admin"
        name_of_slip = "ADMIN"
    ...
    def _f_view_create_in_tab_01_all_container_frames(self):
        ...
        cards_data = [
            {"image": PATH_CARD_ADMIN_QUAN_LY_DATABASE,"text": "QUẢN LÝ ĐỊA CHỈ DATABASE", "click_event": self.f_card_quan_ly_dia_chi_database_click,"name_of_card": "card_frame_ke_hoach_dat_hang", "visitable": True},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "QUẢN LÝ USER", "click_event": self.f_card_06_yeu_cau_dat_hang_click,"name_of_card": "card_frame_yeu_cau_dat_hang", "visitable": True},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "ĐỀ NGHỊ XUẤT KHO", "click_event": self.f_card_DE_NGHI_XUAT_KHO_click,"name_of_card": "card_frame_de_nghi_xuat_kho", "visitable": True},
            
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "DANH SÁCH KHÁCH HÀNG", "click_event": self.f_card_01_click,"name_of_card": "card_frame_danh_sach_khach_hang", "visitable": False},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "DANH SÁCH HÀNG HOÁ", "click_event": self.f_card_02_danh_sach_hang_hoa_click,"name_of_card": "card_frame_2", "visitable": True},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "QUẢN LÝ GÓI THẦU", "click_event": self.f_card_03_click,"name_of_card": "card_frame_3", "visitable": False},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "QUẢN LÝ CÔNG NỢ", "click_event": self.f_card_05_click,"name_of_card": "card_frame_4", "visitable": False},
            {"image": PATH_CARD_ADMIN_CAI_DAT_CHUNG,"text": "BÁO CÁO", "click_event": self.f_card_07_click,"name_of_card": "card_frame_6", "visitable": True},
